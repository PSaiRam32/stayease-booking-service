...
import com.stayease.booking_service.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler{
    ...
    public ResponseEntity<ErrorResponse> handlePaymentFailedException(PaymentFailedException ex){
        ...
        ErrorResponse error=new ErrorResponse("PAYMENT_FAILED",ex.getMessage(),LocalDateTime.now());
    ...
    public ResponseEntity<ErrorResponse> handleRuntimeException(RuntimeException ex){
        ...
        ErrorResponse error = new ErrorResponse("RUNTIME_ERROR",ex.getMessage(),LocalDateTime.now());
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(Exception ex){
        ...
        ErrorResponse error = new ErrorResponse("INTERNAL_ERROR","Something went wrong. Please contact support.",LocalDateTime.now());
        return new ResponseEntity<>(error, HttpStatus.INTERNAL_SERVER_ERROR);
    }
}